...
namespace mvcdata.Controllers
{
    public class ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,proname,cat_id,brand_id,qty,price")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,proname,cat_id,brand_id,qty,price")] product product)
        {
            if (ModelState.IsValid)
            {
